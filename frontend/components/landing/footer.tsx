...
const socialLinks = [
  ...
  { icon: Mail, label: "Contact", href: "mailto:hello@healthsync.com" }
]
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-slate-400 text-sm mb-6 max-w-xs">
              AI-powered medical documentation that helps healthcare providers save time and deliver better care.
            </p>
